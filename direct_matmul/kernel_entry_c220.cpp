...
#elif MATMUL_C220_SUFFIX_VALUE == 60 || MATMUL_C220_SUFFIX_VALUE == 61
#include "c220_gm_to_l1_kernel.h"
    ...
    GM_ADDR cGM, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    KERNEL_TASK_TYPE_DEFAULT(KERNEL_TYPE_MIX_AIC_1_2);
    DirectMatmulC220::RunGmToL1<DTYPE_X1>(aGM, bGM, cGM, user, tilingData);
